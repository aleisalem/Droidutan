...
def testApp(apkPath, avdSerialno="", testDuration=60, logTestcase=False, preExtractedComponents={}, waitInterval=1, takeSnapshots=False, allowCrashes=False, uninstallApp=True):
    """
...
def testAppFromTestcase(apkPath, testCaseFile, avdSerialno="", waitInterval=1, takeSnapshots=False, allowCrashes=False, uninstallApp=True):
    """
